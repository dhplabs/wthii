...
DROP TABLE IF EXISTS	whaight.HFNY_claims_clean_reduced;
CREATE TABLE			whaight.HFNY_claims_clean_reduced
...
INSERT INTO	whaight.HFNY_claims_clean_reduced
(	SELECT
	...
	FROM
		whaight.HFNY_claims_clean
);

--ANALYZE COMPRESSION		whaight.HFNY_claims_clean_reduced;
ANALYZE					whaight.HFNY_claims_clean_reduced;
VACUUM SORT ONLY		whaight.HFNY_claims_clean_reduced;
ANALYZE					whaight.HFNY_claims_clean_reduced;
