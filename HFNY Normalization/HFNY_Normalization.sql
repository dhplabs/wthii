...
DROP TABLE IF EXISTS	whaight.HFNY_claims_clean;
CREATE TABLE			whaight.HFNY_claims_clean
...
INSERT INTO	whaight.HFNY_claims_clean
(	SELECT
...
--ANALYZE COMPRESSION		whaight.HFNY_claims_clean;
ANALYZE					whaight.HFNY_claims_clean;
VACUUM SORT ONLY		whaight.HFNY_claims_clean;
ANALYZE					whaight.HFNY_claims_clean;



DROP TABLE IF EXISTS	whaight.HFNY_claims_ICD_Proc_Codes;
CREATE TABLE			whaight.HFNY_claims_ICD_Proc_Codes
(		claim_ID			VARCHAR( 13 )	ENCODE	ZSTD
	,	member_ID			VARCHAR( 15 )	ENCODE	ZSTD
...
INSERT INTO	whaight.HFNY_claims_ICD_Proc_Codes
...
--ANALYZE COMPRESSION		whaight.HFNY_claims_ICD_Proc_Codes;
ANALYZE					whaight.HFNY_claims_ICD_Proc_Codes;
VACUUM SORT ONLY		whaight.HFNY_claims_ICD_Proc_Codes;
ANALYZE					whaight.HFNY_claims_ICD_Proc_Codes;



DROP TABLE IF EXISTS	whaight.HFNY_claims_CPT_Codes;
CREATE TABLE			whaight.HFNY_claims_CPT_Codes
(		claim_ID	VARCHAR( 13 )	ENCODE	ZSTD
	,	member_ID	VARCHAR( 15 )	ENCODE	ZSTD
...
INSERT INTO	whaight.HFNY_claims_CPT_Codes
(			SELECT		claim_ID	::	VARCHAR( 13 )	AS	claim_ID
					,	member_ID	::	VARCHAR( 15 )	AS	member_ID
...
--ANALYZE COMPRESSION		whaight.HFNY_claims_CPT_Codes;
ANALYZE					whaight.HFNY_claims_CPT_Codes;
VACUUM SORT ONLY		whaight.HFNY_claims_CPT_Codes;
ANALYZE					whaight.HFNY_claims_CPT_Codes;



DROP TABLE IF EXISTS	whaight.HFNY_claims_ICD_DX_Codes;
CREATE TABLE			whaight.HFNY_claims_ICD_DX_Codes
(		claim_ID		VARCHAR( 13 )	ENCODE	ZSTD
	,	member_ID		VARCHAR( 15 )	ENCODE	ZSTD
	,	ICD_Code_Type	VARCHAR(  1 )	ENCODE	ZSTD		/*	'Y' means ICD_10;  'N' means ICD_9	*/
...
INSERT INTO	whaight.HFNY_claims_ICD_DX_Codes
(			SELECT		claim_ID				::	VARCHAR( 13 )	AS	claim_ID
					,	member_ID				::	VARCHAR( 15 )	AS	member_ID
					,	ICD_Code_Type			::	VARCHAR(  1 )	AS	ICD_Code_Type
...
--ANALYZE COMPRESSION		whaight.HFNY_claims_ICD_DX_Codes;
ANALYZE					whaight.HFNY_claims_ICD_DX_Codes;
VACUUM SORT ONLY		whaight.HFNY_claims_ICD_DX_Codes;
ANALYZE					whaight.HFNY_claims_ICD_DX_Codes;



DROP TABLE IF EXISTS	whaight.HFNY_claims_ICD_10_DX_Codes;
CREATE TABLE			whaight.HFNY_claims_ICD_10_DX_Codes
(		claim_ID		VARCHAR( 13 )	ENCODE	ZSTD
	,	member_ID		VARCHAR( 15 )	ENCODE	ZSTD
	,	ICD_Code_Type	VARCHAR(  1 )	ENCODE	ZSTD
	,	ICD_DX_Code		VARCHAR(  8 )	ENCODE	ZSTD
...
INSERT INTO whaight.HFNY_claims_ICD_10_DX_Codes
(	SELECT		claim_ID			::	VARCHAR( 13 )	AS	claim_ID
			,	member_ID			::	VARCHAR( 15 )	AS	member_ID
			,	ICD_Code_Type		::	VARCHAR(  1 )	AS	ICD_Code_Type
			,	CASE	ICD_Code_Type
	...
	FROM		whaight.HFNY_claims_ICD_DX_Codes
);

--ANALYZE COMPRESSION		whaight.HFNY_claims_ICD_10_DX_Codes;
ANALYZE					whaight.HFNY_claims_ICD_10_DX_Codes;
VACUUM SORT ONLY		whaight.HFNY_claims_ICD_10_DX_Codes;
ANALYZE					whaight.HFNY_claims_ICD_10_DX_Codes;



DROP TABLE IF EXISTS	whaight.HFNY_claims_Occurrence_Codes;
CREATE TABLE			whaight.HFNY_claims_Occurrence_Codes
(		claim_ID	VARCHAR( 13 )	ENCODE	ZSTD
	,	member_ID	VARCHAR( 15 )	ENCODE	ZSTD
...
INSERT INTO	whaight.HFNY_claims_Occurrence_Codes
(			SELECT		claim_ID		::	VARCHAR( 13 )	AS	claim_ID
					,	member_ID		::	VARCHAR( 15 )	AS	member_ID
...
--ANALYZE COMPRESSION		whaight.HFNY_claims_Occurrence_Codes;
ANALYZE					whaight.HFNY_claims_Occurrence_Codes;
VACUUM SORT ONLY		whaight.HFNY_claims_Occurrence_Codes;
ANALYZE					whaight.HFNY_claims_Occurrence_Codes;



DROP TABLE IF EXISTS	whaight.HFNY_claims_Occ_Span_Codes;
CREATE TABLE			whaight.HFNY_claims_Occ_Span_Codes
(		claim_ID			VARCHAR( 13 )	ENCODE	ZSTD
	,	member_ID			VARCHAR( 15 )	ENCODE	ZSTD
...
INSERT INTO	whaight.HFNY_claims_Occ_Span_Codes
(			SELECT		claim_ID					::	VARCHAR( 13 )	AS	claim_ID
					,	member_ID					::	VARCHAR( 15 )	AS	member_ID
...
--ANALYZE COMPRESSION		whaight.HFNY_claims_Occ_Span_Codes;
ANALYZE					whaight.HFNY_claims_Occ_Span_Codes;
VACUUM SORT ONLY		whaight.HFNY_claims_Occ_Span_Codes;
ANALYZE					whaight.HFNY_claims_Occ_Span_Codes;



DROP TABLE IF EXISTS	whaight.HFNY_claims_Condition_Codes;
CREATE TABLE			whaight.HFNY_claims_Condition_Codes
(		claim_ID	VARCHAR( 13 )	ENCODE	ZSTD
	,	member_ID	VARCHAR( 15 )	ENCODE	ZSTD
...
INSERT INTO	whaight.HFNY_claims_Condition_Codes
(			SELECT		claim_ID		::	VARCHAR( 13 )	AS	claim_ID
					,	member_ID		::	VARCHAR( 15 )	AS	member_ID
...
--ANALYZE COMPRESSION		whaight.HFNY_claims_Condition_Codes;
ANALYZE					whaight.HFNY_claims_Condition_Codes;
VACUUM SORT ONLY		whaight.HFNY_claims_Condition_Codes;
ANALYZE					whaight.HFNY_claims_Condition_Codes;



DROP TABLE IF EXISTS	whaight.HFNY_claims_Value_Codes;
CREATE TABLE			whaight.HFNY_claims_Value_Codes
(		claim_ID		VARCHAR( 13 )		ENCODE	ZSTD
	,	member_ID		VARCHAR( 15 )		ENCODE	ZSTD
...
INSERT INTO	whaight.HFNY_claims_Value_Codes
(			SELECT		claim_ID			::	VARCHAR( 13 )		AS	claim_ID
					,	member_ID			::	VARCHAR( 15 )		AS	member_ID
...
--ANALYZE COMPRESSION		whaight.HFNY_claims_Value_Codes;
ANALYZE					whaight.HFNY_claims_Value_Codes;
VACUUM SORT ONLY		whaight.HFNY_claims_Value_Codes;
ANALYZE					whaight.HFNY_claims_Value_Codes;



DROP TABLE IF EXISTS	whaight.HFNY_claims_DX_Code_Ptrs;
CREATE TABLE			whaight.HFNY_claims_DX_Code_Ptrs
...
INSERT INTO	whaight.HFNY_claims_DX_Code_Ptrs
(			SELECT		claim_ID			::	VARCHAR( 13 )	AS	claim_ID
					,	member_ID			::	VARCHAR( 15 )	AS	member_ID
...
--ANALYZE COMPRESSION		whaight.HFNY_claims_DX_Code_Ptrs;
ANALYZE					whaight.HFNY_claims_DX_Code_Ptrs;
VACUUM SORT ONLY		whaight.HFNY_claims_DX_Code_Ptrs;
ANALYZE					whaight.HFNY_claims_DX_Code_Ptrs;



DROP TABLE IF EXISTS	whaight.HFNY_Proc_Code_Modifiers;
CREATE TABLE			whaight.HFNY_Proc_Code_Modifiers
(		claim_ID		VARCHAR( 13 )	ENCODE	ZSTD
	,	member_ID		VARCHAR( 15 )	ENCODE	ZSTD
...
INSERT INTO	whaight.HFNY_Proc_Code_Modifiers
(			SELECT		claim_ID					::	VARCHAR( 13 )	AS	claim_ID
					,	member_ID					::	VARCHAR( 15 )	AS	member_ID
...
--ANALYZE COMPRESSION		whaight.HFNY_Proc_Code_Modifiers;
ANALYZE					whaight.HFNY_Proc_Code_Modifiers;
VACUUM SORT ONLY		whaight.HFNY_Proc_Code_Modifiers;
ANALYZE					whaight.HFNY_Proc_Code_Modifiers;



DROP TABLE IF EXISTS	whaight.HFNY_Claim_Cli_Spec_Fields;
CREATE TABLE			whaight.HFNY_Claim_Cli_Spec_Fields
(		claim_ID				VARCHAR( 13 )	ENCODE	RAW
	,	member_ID				VARCHAR( 15 )	ENCODE	RAW
...
INSERT INTO	whaight.HFNY_Claim_Cli_Spec_Fields
(			SELECT		claim_ID					::	VARCHAR( 13 )	AS	claim_ID
					,	member_ID					::	VARCHAR( 15 )	AS	member_ID
...
--ANALYZE COMPRESSION		whaight.HFNY_Claim_Cli_Spec_Fields;
ANALYZE					whaight.HFNY_Claim_Cli_Spec_Fields;
VACUUM SORT ONLY		whaight.HFNY_Claim_Cli_Spec_Fields;
ANALYZE					whaight.HFNY_Claim_Cli_Spec_Fields;
